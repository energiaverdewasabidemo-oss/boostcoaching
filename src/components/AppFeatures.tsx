...
const AppFeatures = () => {
  ...
  return (
    <section id="features" className="py-32 bg-black relative overflow-hidden">
      ...
      <div className="absolute top-40 right-20 w-80 h-80 bg-gold/15 rounded-full blur-[90px] float-element"></div>
      <div className="absolute bottom-40 left-20 w-96 h-96 bg-gold-light/15 rounded-full blur-[100px] float-element" style={{ animationDelay: '3s' }}></div>
      <div className="absolute top-1/2 left-1/4 w-72 h-72 bg-gold-dark/12 rounded-full blur-[80px] float-element" style={{ animationDelay: '5s' }}></div>
