...
const InternationalCovers = () => {
  ...
  return (
    <section ref={sectionRef} id="covers" className="py-16 sm:py-20 lg:py-24 bg-gradient-to-br from-gray-900 via-black to-gray-800 relative overflow-hidden">
      ...
      <div className="absolute top-20 left-10 w-80 h-80 bg-gold/12 rounded-full blur-[90px] float-element"></div>
      <div className="absolute bottom-20 right-10 w-96 h-96 bg-gold-light/12 rounded-full blur-[100px] float-element" style={{ animationDelay: '3.5s' }}></div>
      <div className="absolute top-1/2 right-1/3 w-64 h-64 bg-gold-dark/10 rounded-full blur-[70px] float-element" style={{ animationDelay: '1.5s' }}></div>
