...
const InternationalCovers = () => {
  ...
  return (
    <section ref={sectionRef} id="covers" className="py-16 sm:py-20 lg:py-24 bg-gradient-to-br from-gray-900 via-black to-gray-800 relative overflow-hidden">
      ...
      <div className="absolute top-20 left-10 w-72 h-72 bg-gold/10 rounded-full blur-[50px] float-element"></div>
      <div className="absolute bottom-20 right-10 w-80 h-80 bg-gold-light/10 rounded-full blur-[50px] float-element" style={{ animationDelay: '3.5s' }}></div>
      <div className="absolute top-1/2 right-1/3 w-56 h-56 bg-gold-dark/8 rounded-full blur-[40px] float-element" style={{ animationDelay: '1.5s' }}></div>
