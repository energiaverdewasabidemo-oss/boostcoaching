...
const Authority = () => {
  ...
  return (
    <section ref={sectionRef} id="authority" className="py-16 sm:py-20 lg:py-24 bg-white relative overflow-hidden">
      ...
      <div className="absolute top-20 right-10 w-96 h-96 bg-gold/10 rounded-full blur-[100px] float-element"></div>
      <div className="absolute bottom-20 left-10 w-80 h-80 bg-gold-light/10 rounded-full blur-[90px] float-element" style={{ animationDelay: '3s' }}></div>
